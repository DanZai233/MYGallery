...
func InitDB(cfg *config.Config) error {
	...
	// 自动迁移表结构
	if err := DB.AutoMigrate(&models.User{}, &models.Photo{}, &models.Settings{}, &models.Category{}, &models.PhotoReaction{}, &models.Album{}, &models.PhotoAlbum{}, &models.Comment{}); err != nil {
